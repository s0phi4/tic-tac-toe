...
/***/ function(module, exports, __webpack_require__) {
	...
	var apiGame = __webpack_require__(7);
	...
	var events_game = __webpack_require__(13);
	...
	var dontClick = function dontClick() {
	  $(".sq").off('click');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var api_game = __webpack_require__(7);
	var ui_game = __webpack_require__(14);
	var save = __webpack_require__(8);
	// let data = getFormFields(event.target);

	var onIndex = function onIndex(event) {
	  event.preventDefault();
	  api_game.index().then(function (response) {
	...
	var onCreateGame = function onCreateGame(event) {
	  event.preventDefault();
	  api_game.createGame().then(function (response) {
	    save.game = response.game;
	...
	var onShowGame = function onShowGame(event) {
	  ...
	  api_game.showGame().then(ui_game.showGamesTotal);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var successCreateGame = function successCreateGame() {
	  $('#board').show();
	  $('h2').hide();
	};

	var showGamesTotal = function showGamesTotal(data) {
	  $('h2').show();
	  $('h2').text('You killed time ' + data.games.length + ' times!');
	};

	module.exports = {
	  showGamesTotal: showGamesTotal,
